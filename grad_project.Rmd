...
I wanted to predict whether or not a basketball team would make the NCAA tournament based off of their stats from the season. I decided to use a tree-based method because of the simplicity of the interpretation of the model. I first created a random forest model and a boosted tree model, but the random forest had a smaller RMSE, so I chose to use this model with 400 trees. Even though this model had the smallest RMSE of .237, this still was high considering we were only dealing with 1s and 0s. So, I would conclude that we cannot very accurately predict whether or not a team would make the NCAA tournament based on this model. 
